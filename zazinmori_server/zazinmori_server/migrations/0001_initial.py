# Generated by Django 4.1.1 on 2022-09-17 20:02
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Corp_finance',
            fields=[
                ('finance_id', models.AutoField(db_column='regi_code', primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Corporation',
            fields=[
                ('corp_id', models.AutoField(db_column='regi_code', primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('corp_nm', models.CharField(db_column='corp_nm', max_length=45)),
                ('job', models.CharField(db_column='job', max_length=45)),
                ('employment_date', models.DateField(db_column='employment_date')),
                ('new_or_exp', models.CharField(db_column='new_or_exp', max_length=45)),
                ('question', models.TextField(db_column='question')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birth', models.DateField(db_column='birthday')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('written_date', models.DateField(auto_now_add=True, db_column='written_date')),
